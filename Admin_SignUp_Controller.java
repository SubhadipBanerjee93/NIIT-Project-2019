...
public class Admin_SignUp_Controller extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            int countryCode = parseInt(tempString);
            tempString = request.getParameter("state");
            int stateCode = parseInt(tempString);
            tempString = request.getParameter("branch");
//            System.out.println("Yes 2");
            int branchCode = parseInt(tempString);
...
//           System.out.println("Yes 4");
        ...
        catch (SQLException | UserExistsException ex) {
            getLogger(Admin_SignUp_Controller.class.getName()).log(SEVERE, null, ex);
        }
    }
