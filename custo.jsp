<%-- 
    Document   : custo.jsp
    Created on : Jul 10, 2019, 11:07:14 PM
    Author     : user
--%>
 ...
 <script type="text/javascript">
        ...
        var req;
                    ...
                    function callback()
                    {
                        ...
                        {
                            alert("Your Token Number is "+req.responseText);
                        }
                    }
                }
            </script>
...
<font face="impact" size=20px color="#2243B6">GROUPFUND Q.M.S</font>
</span>
    
</header>

<scroll style="position:relative;padding-top:15px;">
<marquee>GROUPFUND UNCONSOLIDATED FINANCIAL RESULTS-10/08/2019.
</marquee>
</scroll>
...
<font size=4px >
<p> 
1) We would like to inform you that the Branch working timings for select branches have been revised with effect from May 15, 2019. 

<br> <br>
2) Please note, with effect from July 1, 2019, there is a change in schedule of non-maintenance of Monthly Average Balance charges applicable for Savings Accounts variants.
